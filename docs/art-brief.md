...
underfoot badges, the floor-transition banner, D1 systems (gold, gems, shop, mail…), the reward fly-to-HUD step, chest opening frames,
action animations (step, slash, hit…), other FX, Priority B tiles.

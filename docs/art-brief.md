...
the floor-transition banner, D1 systems (gold, gems, shop, mail…), the reward fly-to-HUD step, chest opening frames,
FX (spike trigger, bomb fuse and 3×3 explosion, key and potion collect, exit unlock, wake "!"), Priority B tiles.
